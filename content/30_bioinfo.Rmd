...
What is gene expression? Conceptually, what does gene expression represent? Why
are we interested in it? What are the ways we measure gene expression? What
are some sorts of questions we might ask of a gene expression dataset? How do we
represent and manipulate a gene expression dataset in R+bioconductor?
