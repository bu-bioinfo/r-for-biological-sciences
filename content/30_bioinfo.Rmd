...
statistical analysis, and later transition to data science in general, made it
very useful and accessible to perform the kinds of analyses the new data science
of biology required. It was also a bridge between biologists without a
computational background and statisticians and bioinformaticians, who could
invent methods and implement them into R packages that are easily accessible by
all. The language and the package ecosystems and communities it supports
continue to be a major source of biological discovery and innovation.

As a data science, biology benefits from the main strengths of R and [the
tidyverse](#dw-tidyverse), namely to manipulate, visualize, analyze, and
communicate biological data .
