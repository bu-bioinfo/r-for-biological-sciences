...
+------+-------------------+----------------------------------------------------------+---------------------------+
| 3    | 2/7  & 2/9        | - [Data Sci: Distributions & Tests](#ds-dists)           |                           |
|      |                   | - [R Programming: Structures & Iteration](#prog-struct)  | [Assignment 3]            |
|      |                   | - [Data Sci: Summarization & Cleaning](#ds-summ)         |                           |
|      |                   | - [Data Sci: Clustering](#ds-clust)                      |                           |
+------+-------------------+----------------------------------------------------------+---------------------------+
| 4    | 2/14 & 2/16       | - [Data Sci: Data Modeling](#ds-model)                   |                           |
|      |                   | - [Bio: Gene Expression](#bio-geneexp)                   | [Assignment 4]            |
|      |                   | - [Bio: Differential Expression: Microarrays](#bio-micro)|                           |
|      |                   | - [Bio: Gene Set Enrichment Analysis](#bio-gsea)         |                           |
+------+-------------------+----------------------------------------------------------+---------------------------+
| 5    | 2/22 & 2/23       | - [Bio: High Throughput Sequencing](#bio-hts)            | [Assignment 5]            |
|      |                   | - [Bio: Differential Expression: RNASeq](#bio-rnaseq)    |                           |
|      |                   | - [Bio: Gene Set Enrichment Analysis](#bio-gsea)         |                           |
|      |                   | - [R Programming: Style & Conventions](#prog-style)      |                           |
+------+-------------------+----------------------------------------------------------+---------------------------+
| 6    | 2/28 & 3/2        | - [Data Viz: Responsible Plotting](#dv-resp)             | [Assignment 6]            |
+------+-------------------+----------------------------------------------------------+---------------------------+
| 7    | 3/14 & 3/16       | - [Bio: Biological Networks](#bio-networks)              | [Assignment 7]            |
|      |                   | - [Data Sci: Network Analysis](#ds-networks)             |                           |
|      |                   | - [Data Viz: Network Viz](#ds-network-viz)               |                           |
+------+-------------------+----------------------------------------------------------+---------------------------+
| 8    | 3/21 & 3/23       | - [Bio: Single Cell Sequencing](#bio-scseq)              | [Assignment 8]            |
+------+-------------------+----------------------------------------------------------+---------------------------+
| 9    | 3/28 & ~~3/30~~   | - [RShiny]                                               | [Project]                 |
+------+-------------------+----------------------------------------------------------+---------------------------+
