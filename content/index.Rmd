...
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 4]  | **2/14** & 2/16   | - Data Sci: PCA & Clustering                 |                 |
...
|           | **Note: 2/22 is a | - Bio: RNASeq                                |                 |
|           | Tuesday**         | - Bio: Count Data                            | [Assignment 4]  |
|           |                   | - Bio: Differential Expression: RNASeq       |                 |
|           |                   | - Bio: Gene Set Enrichment Analysis          |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 6]  | **2/28** & 3/2    | - Data Sci: Distributions                    |                 |
|           |                   | - Data Sci: Statistical Tests                | [Assignment 5]  |
|           |                   | - R Programming: Style & Conventions         |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
|           | 3/7 & 3/9         |  Spring Break                                |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 7]  | **3/14** & 3/16   | - Data Viz: Responsible Plotting             | [Assignment 6]  |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 8]  | 3/21 & 3/23       | - RShiny                                     | [Assignment 7]  |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 9]  | **3/28** & 3/30   | - EngineeRing                                | [Assignment 7]  |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 10] | **4/4** & 4/6     | - Bio: Biological Networks                   |                 |
|           |                   | - Data Sci: Network Analysis                 | [Project]       |
|           |                   | - Data Viz: Network Viz                      |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 11] | ~~4/11 & 4/13~~   | - Project work, no class                     |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 12] | ~~4/20~~          | - Project work, no class                     |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 13] | ~~4/25 & 4/27~~   | - Project work, no class                     |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
| [Week 14] | ~~5/2~~ & 5/4     | - Course wrap up & feedback                  |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
|           | 5/9               | - First day of exam period                   | Project due     |
|           |                   |                                              |                 |
+-----------+-------------------+----------------------------------------------+-----------------+
