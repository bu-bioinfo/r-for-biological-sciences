---
title: "R for Biological Sciences"
---
...
```{r syllabus, echo=FALSE, message=FALSE}
library(kableExtra)
schedule <- readr::read_csv("../schedule.csv") %>%
   dplyr::mutate(leclink=stringr::str_glue("[{lecture}]({lecture_slug}.html)")) %>%
   dplyr::select(date, leclink, assignment)
kbl(schedule)
```
