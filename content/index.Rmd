...
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 2] | 1/31 & 2/2        | - [Data Wrangling: Arranging](#dw-arranging)             |                           |
|          |                   | - [Data Viz: Grammar of Graphics](#dv-gg)                | [Assignment 2]            |
|          |                   | - [Bio: Bioconductor Basics](#bio-bioconductor)          |                           |
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 3] | 2/7  & 2/9        | - [Data Sci: Data Modeling](#ds-model)                   |                           |
...
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 4] | 2/14 & 2/16       | - [Data Sci: Distributions & Tests](#ds-dists)           |                           |
...
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 5] | 2/22 & 2/23       | - [Bio: High Throughput Sequencing](#bio-hts)            |                           |
|          |                   | - [Bio: Differential Expression: RNASeq](#bio-rnaseq)    | [Assignment 5]            |
|          |                   | - [Bio: Gene Set Enrichment Analysis](#bio-gsea)         |                           |
|          |                   | - [R Programming: Style & Conventions](#prog-style)      |                           |
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 6] | 2/28 & 3/2        | - [Data Viz: Responsible Plotting](#dv-resp)             | [Assignment 6]            |
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 7] | 3/14 & 3/16       | - [Bio: Single Cell Sequencing](#bio-scseq)              | [Assignment 7]            |
|          |                   | - [R Programming: Pipelines & Workflows](#prog-workflows)|                           |
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 8] | 3/21 & 3/23       | - [RShiny]                                               | [Assignment 8]            |
+----------+-------------------+----------------------------------------------------------+---------------------------+
| [Week 9] | 3/28 & 3/30       | - [Bio: Biological Networks](#bio-networks)              |                           |
