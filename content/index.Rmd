...
```{r, echo=F}
print(paste("Site last updated",format(Sys.time(), "%a %b %d %Y")))
```
...
+=================================================+==============+====================+==============+
| [Week 1] \| [slides](slides/week_1_slides.html) | 9/6 & 9/11   | -   Preliminaries  | [Assignment  |
|                                                 |              | -   Data in        | 0]           |
|                                                 |              |     Biology        |              |
|                                                 |              | -   R Programming  |              |
|                                                 |              |     Basics         |              |
+-------------------------------------------------+--------------+--------------------+--------------+
| [Week 2] \| [slides](slides/week_2_slides.html) | 9/13 & 9/18  | -   EngineeRing:   | [Base R]     |
|                                                 |              |     Unit Testing   |              |
|                                                 |              | -   Assignment     |              |
|                                                 |              |     Structure      |              |
|                                                 |              | -   Data Wrangling |              |
...
|                                                 |              |     Basics         |              |
+-------------------------------------------------+--------------+--------------------+--------------+
| [Week 3] \| [slides](slides/week_3_slides.html) | 9/20 & 9/25  | -   R in Biology   | [Tidyverse   |
|                                                 |              | -   Bio:           | Basics]      |
|                                                 |              |     Bioconductor   |              |
|                                                 |              |     Basics         |              |
+-------------------------------------------------+--------------+--------------------+--------------+
| [Week 4] \| [slides](slides/week_4_slides.html) | 9/27 & 10/2  | -   Data Viz:      | [Bi          |
|                                                 |              |     Grammar of     | oinformatics |
|                                                 |              |     Graphics       | Basics]      |
|                                                 |              | -   Bio: Gene      |              |
|                                                 |              |     Expression     |              |
|                                                 |              | -   Bio:           |              |
...
|                                                 |              |     Microarrays    |              |
+-------------------------------------------------+--------------+--------------------+--------------+
| [Week 5] \| [slides](slides/week_5_slides.html) | ~~10/9~~ &   | -   Data Sci: PCA  | [Data        |
|                                                 | 10/11 Note:  |     & Clustering   | Science      |
|                                                 | 10/9 is a    | -   Data Vis:      | Basics]      |
|                                                 | holiday, no  |     Heatmaps &     |              |
|                                                 | class        |     Dendrograms    |              |
|                                                 |              | -   R Programming: |              |
|                                                 |              |     Structures &   |              |
|                                                 |              |     Iteration      |              |
+-------------------------------------------------+--------------+--------------------+--------------+
| [Week 6] \| [slides](slides/week_6_slides.html) | 10/16 &      | -   Bio: High      | [Counts      |
|                                                 | 10/18        |     Throughput     | Analysis]    |
|                                                 |              |     Sequencing     |              |
|                                                 |              | -   Bio: RNASeq    |              |
|                                                 |              | -   Bio: Count     |              |
|                                                 |              |     Data           |              |
