...
| [slides](s     |                |  Preliminaries |                |
| lides/week_%20 |                | -   Data in    |                |
| 1_slides.html) |                |     Biology    |                |
|                |                | -   R          |                |
|                |                |                |                |
|                |                |    Programming |                |
|                |                |     Basics     |                |
...
| [slides](s     |                |   EngineeRing: |                |
| lides/week_%20 |                |     Unit       |                |
| 2_slides.html) |                |     Testing    |                |
|                |                | -   Assignment |                |
|                |                |     Structure  |                |
|                |                | -   Data       |                |
|                |                |     Wrangling  |                |
...
|                |                |     Basics     |                |
+----------------+----------------+----------------+----------------+
| [Week 3] \|    | 9/20 & 9/25    | -   R in       | [Tidyverse     |
| [slides](s     |                |     Biology    | Basics]        |
| lides/week_%20 |                | -   Bio:       |                |
| 3_slides.html) |                |                |                |
|                |                |   Bioconductor |                |
|                |                |     Basics     |                |
...
| [slides](s     |                |     Grammar of | oinformatics   |
| lides/week_%20 |                |     Graphics   | Basics]        |
...
|                |                |    Microarrays |                |
+----------------+----------------+----------------+----------------+
| [Week 5] \|    | ~~10/9~~ &     | -   Data Sci:  | [Data Science  |
| [slides](s     | 10/11 Note:    |     PCA &      | Basics]        |
| lides/week_%20 | 10/9 is a      |     Clustering |                |
| 5_slides.html) | holiday, no    | -   Data Vis:  |                |
|                | class          |     Heatmaps & |                |
|                |                |                |                |
|                |                |    Dendrograms |                |
|                |                | -   R          |                |
...
|                |                |     Iteration  |                |
+----------------+----------------+----------------+----------------+
| [Week 6] \|    | 10/16 & 10/18  | -   Bio: High  | [Counts        |
| [slides](s     |                |     Throughput | Analysis]      |
| lides/week_%20 |                |     Sequencing |                |
| 6_slides.html) |                | -   Bio:       |                |
|                |                |     RNASeq     |                |
|                |                | -   Bio: Count |                |
|                |                |     Data       |                |
...
|                |                |     Analysis   |                |
+----------------+----------------+----------------+----------------+
| [Week 7]       | 10/23 & 10/25  | -   Data Sci:  | [ Differential |
|                |                |                | Expression     |
...
|                |                |    Conventions |                |
+----------------+----------------+----------------+----------------+
| [Week 8]       | 10/30 & 11/1   | -   RShiny     | [ Differential |
|                |                |                | Expression     |
|                |                |                | Part 2]        |
+----------------+----------------+----------------+----------------+
| [Week 9]       | 11/6 & 11/8    | -              | [Rshiny        |
|                |                |    EngineeRing | Basics]        |
+----------------+----------------+----------------+----------------+
| [Week 10]      | 11/13 & 11/15  | -   Data Viz:  | [RShiny        |
|                |                |     Plot Week! | Basics] cont'd |
|                |                | -   Data Viz:  |                |
|                |                |                |                |
|                |                |    Responsible |                |
|                |                |     Plotting   |                |
...
|                |                |     Workshops  |                |
+----------------+----------------+----------------+----------------+
| [Week 14]      | 12/11          | -   Course     |                |
|                |                |     wrap up &  |                |
|                |                |     feedback   |                |
+----------------+----------------+----------------+----------------+
|                | 12/15          | -   First day  | Project due    |
|                |                |     of exam    |                |
|                |                |     period     |                |
+----------------+----------------+----------------+----------------+
