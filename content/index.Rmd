...
* **Mae Rose Gott** (BU BF MS Alumna '21) is a new Research Staff member working
  with me on a number of different projects across many different areas. She
  will be helping organize the course materials as we go forward.
* **Taylor Falk** (BU BF MS Alumnus '21) is a Bioinformatics Developer working
  with me and the VA PTSD Brain Bank, developing infrastructure to support data
