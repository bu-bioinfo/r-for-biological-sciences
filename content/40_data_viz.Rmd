...
We will use the [box and whisker
geometry](https://ggplot2.tidyverse.org/reference/geom_boxplot.html) with
`geom_boxplot()` to look at the distributions of `age_at_death`:
...
changed, but the vector remains one dimensional.
