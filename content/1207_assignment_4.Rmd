...
## Instructions {-}
Our main focus for this assignment [...]
...
Details: The output of this will be tested for the appropriate test run and PCs used to plot. It may be visually inspected as part of your grade. Test function will look for: data dimensions, PCAs used, x and y variables, and graph type.
...
Details: This function will be tested on a `(n x _S_)` tibble. Output will be tested for dimensions, proper title, scaling functionality and graph type
...
Details: This function will be tested on a `(n x _S_)` tibble. Output will be tested for dimensions, proper title, scaling functionality and graph type, and existance of a line representing the average mean and variance values.

## Hints {-}

- Make sure you don't have any rownames on any of the tibbles your function(s) return. You should get a warning in your R console if you do. 
...
- The Bioconductor vignette for DESeq2 is linked in part 3 of your `report.Rmd`. [It can also be found here](http://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html#data-transformations-and-visualization))
...
- There may be occasions where you will need to reshape your data from a wide format to a long format
