...
> Image of basic Shiny app and script?
> Shiny gallery demo??
...
...
ui <- fluidPage(
  sliderInput(inputId = "pyramids", min = 0, max = 10, label = "How many pyramids are there?", value = 0, step = 1)
)
...
```
...
## Exercises
- UI functions just output HTML
- Experiment with inputs and outputs
- fluid panel design, create a fun collage?
- Server works like normal R, print some data into the console using buttons (cheap debug)
- upload a file
- Generative art