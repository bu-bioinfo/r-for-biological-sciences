...
Because
functions represent code, most functions are useful only if they can be passed
different inputs. In R, functions accept arguments using the following pattern:
...
consequence is the style of programming it entails. Compare the following two
equivalent R code snippets:
