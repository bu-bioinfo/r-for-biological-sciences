...
## Assignment commits after due

* Your last commit prior to the start of class will be used as your submission
* You may push later, but the TAs will check out the state of your code prior
  to 2:30pm Wednesdays
  
## Assignment 2 Clarifications

* You may use `report.Rmd` to help troubleshoot
* Example expression data has an R quirk:
  - `read.table` functions expect first row to have 1 fewer column than subsequent rows
  - First column is expected to be row names
