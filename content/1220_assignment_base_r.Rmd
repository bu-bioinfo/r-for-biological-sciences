...
empty project repo can be found here:

[https://github.com/bu-bioinfo/bf591-assignment-1](https://github.com/bu-bioinfo/bf591-assignment-1)
...
:::{.box .note}
Note that in Assignment 1 there is no `test_main.R` and does not use the unit
testing framework as described in the [Assignment Overview]. For this assignment
you should just compare your knitted report to `reference_report.html`. All
subsequent assignments have `test_main.R`.
:::
...
6. When you have developed function bodies for all the functions and executed
