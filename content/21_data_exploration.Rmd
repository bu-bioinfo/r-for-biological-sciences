...
*central tendency*. But this is only one aspect of the data; we have yet to
describe what the data do for values outside this point estimate of central
tendency; in other words, we have not expressed the spread, or *variance* of the
data.

We decide that perhaps computing the [standard deviation](https://en.wikipedia.org/wiki/Standard_deviation) of the data may
