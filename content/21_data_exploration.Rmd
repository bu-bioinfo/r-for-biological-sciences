...
What is a data summary? What are some of the different ways to summarize data?
Point estimates (mean, median), dispersion (i.e. variance), distribution.
...
## Statistical Distributions & Tests {#ds-dists}
