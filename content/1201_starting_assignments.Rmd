...
6. Login to [https://scc-ondemand.bu.edu/](SCC interactive). Start an
   ...
   :::{.box .note}
   Alternatively, you may run RStudio on your personal computer, but beware the
   instructions in this tutorial may not be exactly what you see. You will
   need to install git on your machine. Here is a [guide](https://support.posit.co/hc/en-us/articles/200532077)
   :::
...
8. With the prompt open, select `Version Control` > `git`, and paste your repo's
   url into the first prompt. Feel free to rename the project. You can change
   where this folder is setup on SCC, but I find `~/Documents` or
   `~/Documents/BF591` to be a good home for organizing my various projects.
   
   ![](img/how_to_2-prompt.png)
   
9. You will need to login to complete this process, enter your GitHub username
